      ...
      <div class="comDetails">
        ...
        <div class="riskPoint">
          <el-table :data="comInfo.riskPointData" style="width: 100%" :header-cell-style="headerCellStyle" :row-style="rowStyle" :cell-style="cellStyle" >
            ...
            <el-table-column prop="point" label="风险点" width="140"></el-table-column>
            <el-table-column prop="riskDetail" label="风险详情" width="360"></el-table-column>
            <el-table-column prop="state" label="状态" width=""></el-table-column>
            <el-table-column prop="result" label="核查结果" width=""></el-table-column>
            <el-table-column prop="feedback" label="反馈进度" width=""></el-table-column>
            <el-table-column prop="checkDetail" label="核查详情" width="380"></el-table-column>
            <el-table-column prop="checkDate" label="核查时间" width=""></el-table-column>
...
export default {
  ...
  methods: {
    testFunction() {
      debugger;
      console.log(this.common.getLoginUser());
    },
    //表格头部样式
    ...
    cellStyle({ row, column, rowIndex, columnIndex }) {
      if (columnIndex === 1 || columnIndex === 2 || columnIndex === 6) {
        ...
        return "padding:10px;border-bottom:1px solid rgba(70, 160, 252, 0.2);";
      }
    },
    //文件超出个数限制时的钩子
...
// .el-checkbox-button:last-child .el-checkbox-button__inne {
//   border: 1px solid $fontColorBlue !important;
