  ...
  <div class="warn-content orgDetails">
      ...
      <div class="comDetails">
        <div class="title display-flex justify-content-space-between align-items-center">
          ...
          <div class="right red">核查总进度0/5</div>
        </div>
        <div class="riskPoint" style="padding-bottom:30px;">
      ...
      <div class="comDetails">
        <div class="title display-flex justify-content-space-between align-items-center">
          ...
          <div class="right blue">反馈进度3/3</div>
        </div>
        <div class="riskPoint" style="padding-bottom:30px;">
          <el-table :data="comInfo.meetingDetail" style="width: 100%" :header-cell-style="headerCellStyle2" :row-style="rowStyle" :cell-style="cellStyle2" >
            <el-table-column type="index" label="序号" min-width="60"></el-table-column>
            <el-table-column prop="create_date" label="时间" min-width="100"></el-table-column>
            <el-table-column prop="unit" label="单位" min-width="100"></el-table-column>
            <el-table-column prop="detail" label="会商详情" min-width="980"></el-table-column>
          </el-table>
        </div>
      </div>
      <div class="comDetails">
        ...
        <div class="describeCont">
            <p style="margin-bottom:10px;color:#FF5361;font-size:18px;">机构状态：立案</p>
            <p>会商详情会商详情会商详情会商详情会商详情会商详情会商详情</p>
            <div class="download">
                <i class="iconfont icon-biaoqian"></i>
                <a href="">宁波米粒控股公司风险报告.pdf</a>
            </div>
        </div>
      </div>
      <div class="comDetails">
        ...
        <div class="describeCont">
            <p style="margin-bottom:10px;">2018-10-10 14:26:56 来自金融办</p>
            <p>会商详情会商详情会商详情会商详情会商详情会商详情会商详情</p>
        </div>
      </div>
      <p class="tc" style="padding: 10px 0;">会商截止日期：2018-10-15 16:30:00  请您尽快回复</p>
      <div class="comDetails" style="margin-top:0;">
        <div class="disposeBox">
            <el-button type="primary" class="disposition" @click="comInfo.DialogBox.disposition = true">会商回执</el-button>
            <!--会商回执-->
            <el-dialog title="会商回执" :visible.sync="comInfo.DialogBox.disposition" width="40%" center :show-close="false" :modal-append-to-body="false" :close-on-click-modal="false">
                <dl >
                ...
                <el-button class="confirm" type="primary" @click="comInfo.DialogBox.disposition = false">回执</el-button>
                </span>
            </el-dialog>
            <!--会商回执-->
        </div>
        ...
        meetingDetail: [
            {
                ...
                unit: '市金融办',
                detail: '会商详情会商详情会商详情会商详情会商详情会商详情会商详情会商详情会商详情'
            },
            {
                create_date: '2018 10-10',
                unit: '市金融办',
