<!-- 会商回执弹框 created by zp -->
<template>
  <div class="dialogBody">
    <el-dialog title="会商回执" :visible.sync="dialogVisible" width="40%" center :show-close="false" :modal-append-to-body="false" :close-on-click-modal="false">
      <dl >
...
export default {
  ...
  methods: {
    ...
    consReceipt(){
      ...
      console.log(this.warningDownId);
      // console.log(this.addFileId);
      this.$axios({
        method: "post",
        url: this.HOME +"warningDown/addWarningBack",
        headers: {
        ...
        data: {
          ...
          warningDownId: this.warningDownId
