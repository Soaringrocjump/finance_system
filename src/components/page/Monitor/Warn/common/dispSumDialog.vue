<!-- 处置总结弹框 created by zp -->
<template>
  <div class="dialogBody">
    <el-dialog title="处置总结" :visible.sync="dialogVisible" width="40%" center :show-close="false" :modal-append-to-body="false" :close-on-click-modal="false">
      <dl >
      ...
      <dd>
          ...
          <el-input v-model="remark"  type="textarea" :rows="4" placeholder="请输入处置总结（必填）" style="margin-top:10px;"></el-input>
      </dd>
      </dl>
      <el-upload
      class="upload-demo"
